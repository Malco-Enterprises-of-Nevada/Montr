...
pub struct ClientCapabilities {
    /// Supported video formats (e.g., ["mp4", "webm", "mkv"])
    pub video_formats: Vec<String>,

    /// Supported image formats (e.g., ["jpg", "png", "gif"])
    pub image_formats: Vec<String>,

    /// Maximum supported resolution (e.g., "1920x1080")
...
pub struct StatusUpdateMessage {
    ...
    /// ID of currently playing media (if any)
    #[serde(rename = "currentMediaId", skip_serializing_if = "Option::is_none")]
...
pub struct PlaylistItem {
    ...
    #[serde(rename = "imageDuration", skip_serializing_if = "Option::is_none")]
...
mod tests {
    ...
    fn test_register_message_serialization() {
        ...
        assert!(json.contains(r#""clientName":"Test Client"#));
    }
    ...
    fn test_status_update_message_serialization() {
        ...
        assert!(json.contains(r#""currentMediaId":42"#));
    ...
    fn test_playlist_item_equality() {
        let media = MediaInfo {
            ...
            filepath: "/storage/test.mp4".to_string(),
    ...
    fn test_default_capabilities() {
        ...
        assert!(caps.video_formats.contains(&"mp4".to_string()));
        assert!(caps.image_formats.contains(&"jpg".to_string()));
        assert_eq!(caps.max_resolution, "1920x1080");
        assert_eq!(caps.hardware_acceleration, true);
    }
}
